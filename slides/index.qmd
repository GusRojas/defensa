...
4. Definir criterio de selección: Proponer un índice de eficiencia global (exactitud-latencia-tamaño) para determinar la arquitectura óptima para el módulo perceptual del dron.
...
![](assets/loss_comparison.png){width=100% fig-align="center" style="border-radius:10px;"}

## {.center}

![](assets/overfitting_analysis.png){width=100% fig-align="center" style="border-radius:10px;"}
...
![](assets/latency_distribution_rpi5.png){width=100% fig-align="center" style="border-radius:10px;"}
